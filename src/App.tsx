...
export default function App(opts: UseOhcaOpts = {}) {
  const o = useOHCA(opts);
      ...
      <div style={{ padding: '13px 15px 26px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
          ...
          <TacTile
            ...
            big={
              o.amioRemain == null ? '給藥' : o.amioRemain <= 0 ? '可給藥' : fmtClock(o.amioRemain)
            }
